...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // The Card will get its style from our new 'cardTheme'
    return InkWell(
      onTap: onTap,
      child: Card(
        // The theme's 'clipBehavior' will handle the clipping
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            // This Expanded makes the image take up most of the space
            Expanded(
